<#assign fwd_show_header_search = getterUtil.getBoolean(themeDisplay.getThemeSetting("fwd-show-header-search")) />
<#assign fwd_show_breadcrumd = getterUtil.getBoolean(themeDisplay.getThemeSetting("fwd-show-breadcrumb")) />
